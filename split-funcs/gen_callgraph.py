...
if __name__ == '__main__':
    ...
    prog_out_dir = '/root/output/' + project_name + '-funcs/'
    # in_path = prog_out_dir + '0name_list'
    in_path = prog_out_dir + '0func_info.json'
    standard_path = '/root/data/CheckFunction/standardC'
    prog_path = prog_out_dir + '0func_list'
    
    out_path = prog_out_dir + '0call_graph.json'
