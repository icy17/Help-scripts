...
if __name__ == '__main__':
    home_dir = '/root'
    project_dir = home_dir + '/software/libpcap'
    out_dir = home_dir + '/output/' + project_dir.split('/')[-1] + '-funcs/'
    standard_path = home_dir + '/data/CheckFunction/standardC'
